...
### Step 4 — Tier 2: spawn `pipeline-disambiguator` (`gpt-5.6-luna`)
...
- `chosen` is null (refusal) → surface the rationale to the user and stop. Do NOT silently fall back to tier 3 — the disambiguator has more context than the matcher and its refusal is informative.
